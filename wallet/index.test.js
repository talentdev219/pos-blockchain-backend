...
describe('Wallet', () => {
    ...
    // -- condition: calculate the balance
    describe('calculating a balance', () => {
        ...
        // test #2 
        it('calculate the balance for blockchain transactions matching th sender', () => {
            expect(senderWallet.calculateBalance(bc)).toEqual(INITIAL_BALANCE - (addBalance * repeatAdd))
        })

        // --- kondisi: calculate recent transaction of a wallet ---
        describe('assume recipinet conducts a transaction', () => {
            ...
            // -- kondisi: sender kirim beberapa transaksi lagi ke recipient --- 
            describe('then the sender sends another transaction to recipient', () => {
                beforeEach(() => {
                    tp.clear()
                    senderWallet.createTransaction(wallet.publicKey, addBalance, bc, tp)
                    bc.addBlock(tp.transactions)
                ...
                // test: kalkulasi balance dari transaksi terakhir
